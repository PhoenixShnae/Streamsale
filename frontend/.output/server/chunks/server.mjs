...
const _routes = [
  {
    name: (_a = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _a : "index",
    path: (_b = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _b : "/",
    file: "D:/streamsale_v2/frontend/pages/index.vue",
    children: [],
  ...
  },
  {
    ...
    path: (_d = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) != null ? _d : "/player/_name",
    file: "D:/streamsale_v2/frontend/pages/player/_name.vue",
    children: [],
